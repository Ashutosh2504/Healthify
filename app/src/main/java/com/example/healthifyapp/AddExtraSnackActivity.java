...
public class AddExtraSnackActivity extends AppCompatActivity   implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_extra_snack);
     ...
     //   decreaseBtn = findViewById(R.id.decrease);
        ...
        back_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(AddExtraSnackActivity.this, PrimaryAnalysisDietACtivity.class);
       ...
       /* addbreakfastedittext.addTextChangedListener(new TextWatcher() {
        ...
        btnsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    try {
                        boolean networkConectivity =  NetworkConnectivity.isConnected(AddExtraSnackActivity.this);
                        if (networkConectivity) {
                            ...
                            Toast.makeText(AddExtraSnackActivity.this, "Add ExtraSnack Successfully", Toast.LENGTH_SHORT).show(); // Due to no response from get from api but data is stored.. 200 code is returned and check log for response
                            ...
                            NetworkConnectivity.networkConnetivityShowDialog(AddExtraSnackActivity.this);
                ...
                {
                    Toast.makeText(AddExtraSnackActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
        ...
        try {
            timetext.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    TimePickerDialog mTimePicker = new TimePickerDialog(AddExtraSnackActivity.this, new TimePickerDialog.OnTimeSetListener() {
                        @Override
            ...
            datetext1.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    DatePickerDialog dialog = new DatePickerDialog(AddExtraSnackActivity.this, new DatePickerDialog.OnDateSetListener() {
                        @Override
        ...
        {
            Toast.makeText(AddExtraSnackActivity.this, "TTTT"+e.getMessage(), Toast.LENGTH_SHORT).show();
            Log.d("Errorin picking Time",":"+e.getMessage().toString());
            Toast.makeText(AddExtraSnackActivity.this, "DDDD"+e.getMessage(), Toast.LENGTH_SHORT).show();
                        ...
                        for (int i=0; i<resultList.size();i++){
                            ...
                            try {
                                if (resultList.get(i).getDietAnalysisType().equalsIgnoreCase("Primary Analysis Of Your Diet")) {
                                    if (resultList.get(i).getDietType().equalsIgnoreCase("ADD EXTRA SNACK")) {
...
//        DietApi dietApi=retrofit.create(DietApi.class);
        try {
            ...
            call.enqueue(new Callback<DietDataModel.Root>() {
                ...
                public void onResponse(Call<DietDataModel.Root> call, Response<DietDataModel.Root> response) {
                    ...
                    Toast.makeText(AddExtraSnackActivity.this, "Add diet", Toast.LENGTH_SHORT).show();

                    if (response.code() == 200) {
                        String responseString = "Response code :" + response.code();
                        Toast.makeText(AddExtraSnackActivity.this, "Add diet Successfully", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(AddExtraSnackActivity.this, "Failed", Toast.LENGTH_SHORT).show();
                        String responseString = "Response code :" + response.code();
                        Log.e("TAG", "Response =" + responseString);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
        ...
        Toast.makeText(AddExtraSnackActivity.this, "Selected Item is: \t" + breakFastfood, Toast.LENGTH_LONG).show();
        SharedPreference.saveSharedSetting(AddExtraSnackActivity.this, "breakfast", breakFastfood);
    }
}