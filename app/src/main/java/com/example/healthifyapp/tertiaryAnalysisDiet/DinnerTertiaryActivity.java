...
public class DinnerTertiaryActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
   ...
   EditText  textViewquantity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dinner_tertiary);
      ...
      //  kcalstext = findViewById(R.id.kcal);
       ...
       // increaseBtn.setOnClickListener(new View.OnClickListener() {
        ...
        //
        //
        //                    Toast.makeText(DinnerTertiaryActivity.this, "cal"+kcalorie, Toast.LENGTH_SHORT).show();
       ...
       /* addbreakfastedittext.addTextChangedListener(new TextWatcher() {
        ...
        btnsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    boolean networkConectivity =  NetworkConnectivity.isConnected(DinnerTertiaryActivity.this);
        ...
        timetext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TimePickerDialog mTimePicker = new TimePickerDialog(DinnerTertiaryActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        datetext1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DatePickerDialog dialog = new DatePickerDialog(DinnerTertiaryActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        try {
            ...
            call.enqueue(new Callback<DietDataModel.Root>() {
                ...
                public void onResponse(Call<DietDataModel.Root> call, Response<DietDataModel.Root> response) {
                    ...
                    Toast.makeText(DinnerTertiaryActivity.this, "Add diet", Toast.LENGTH_SHORT).show();

                    if (response.code() == 200) {
                        String responseString = "Response code :" + response.code();
                        Toast.makeText(DinnerTertiaryActivity.this, "Add ExtraBreakfast Diet Successfully", Toast.LENGTH_SHORT).show();
