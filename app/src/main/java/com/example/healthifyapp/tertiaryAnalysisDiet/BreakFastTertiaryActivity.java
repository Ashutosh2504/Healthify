...
public class BreakFastTertiaryActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
  ...
  EditText textViewquantity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_break_fast_tertiary);
       ...
       // decreaseBtn = findViewById(R.id.decrease);
        ...
        back_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(BreakFastTertiaryActivity.this, TertiaryAnalysisDietActivity.class);
      ...
      //  increaseBtn.setOnClickListener(new View.OnClickListener() {
        ...
        btnsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    try {
                        boolean networkConectivity =  NetworkConnectivity.isConnected(BreakFastTertiaryActivity.this);
                        if (networkConectivity) {
                            if (isAllFieldsChecked = CheckAllFields()) {
                              ...
                              Toast.makeText(BreakFastTertiaryActivity.this, "Add Breakfast Diet Successfully", Toast.LENGTH_SHORT).show(); // Due to no response from get from api but data is stored.. 200 code is returned and check log for response


                        }
                        else {
                            NetworkConnectivity.networkConnetivityShowDialog(BreakFastTertiaryActivity.this);
                ...
                {
                    Toast.makeText(BreakFastTertiaryActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
        ...
        try {
            timetext.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    TimePickerDialog mTimePicker = new TimePickerDialog(BreakFastTertiaryActivity.this, new TimePickerDialog.OnTimeSetListener() {
                        @Override
            ...
            datetext1.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    DatePickerDialog dialog = new DatePickerDialog(BreakFastTertiaryActivity.this, new DatePickerDialog.OnDateSetListener() {
                        @Override
        ...
        {
            Toast.makeText(BreakFastTertiaryActivity.this, "TTTT"+e.getMessage(), Toast.LENGTH_SHORT).show();
            Log.d("Errorin picking Time",":"+e.getMessage().toString());
            Toast.makeText(BreakFastTertiaryActivity.this, "DDDD"+e.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void getReports1(int userAccountId) {
...
//        DietApi dietApi=retrofit.create(DietApi.class);
        try {
            ...
            call.enqueue(new Callback<DietDataModel.Root>() {
                ...
                public void onResponse(Call<DietDataModel.Root> call, Response<DietDataModel.Root> response) {
                    ...
                    //Toast.makeText(Breakfast.this, "Add diet", Toast.LENGTH_SHORT).show();

                    if (response.code() == 200) {
                        String responseString = "Response code :" + response.code();
                        Toast.makeText(BreakFastTertiaryActivity.this, "Add diet Successfully", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(BreakFastTertiaryActivity.this, "Failed", Toast.LENGTH_SHORT).show();
                        String responseString = "Response code :" + response.code();
                        Log.e("TAG", "Response =" + responseString);
  ...
  /*  private void getItemDiet(String s) {
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
        ...
        Toast.makeText(BreakFastTertiaryActivity.this, "Selected Item is: \t" + breakFastfood, Toast.LENGTH_LONG).show();
        SharedPreference.saveSharedSetting(BreakFastTertiaryActivity.this, "breakfast", breakFastfood);
    }
