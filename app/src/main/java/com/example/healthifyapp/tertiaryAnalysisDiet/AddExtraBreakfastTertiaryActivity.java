...
public class AddExtraBreakfastTertiaryActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    Root modelList;
   ...
   EditText textViewquantity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_extra_breakfast_tertiary);
     ...
     //   increaseBtn = findViewById(R.id.increase);
      ...
      //  increaseBtn.setOnClickListener(new View.OnClickListener() {
        ...
        //
        //
        //                    Toast.makeText(AddExtraBreakfastTertiaryActivity.this, "cal"+kcalorie, Toast.LENGTH_SHORT).show();
       ...
       /* addbreakfastedittext.addTextChangedListener(new TextWatcher() {
        ...
        btnsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    boolean networkConectivity =  NetworkConnectivity.isConnected(AddExtraBreakfastTertiaryActivity.this);
                    if (networkConectivity) {
                        if (isAllFieldsChecked = CheckAllFields()) {
                         ...
                         Toast.makeText(AddExtraBreakfastTertiaryActivity.this, "Add Extra Breakfast Successfully", Toast.LENGTH_SHORT).show(); // Due to no response from get from api but data is stored.. 200 code is returned and check log for response

                    }
                    else {
                        NetworkConnectivity.networkConnetivityShowDialog(AddExtraBreakfastTertiaryActivity.this);
        ...
        timetext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TimePickerDialog mTimePicker = new TimePickerDialog(AddExtraBreakfastTertiaryActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        datetext1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DatePickerDialog dialog = new DatePickerDialog(AddExtraBreakfastTertiaryActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        try {
            ...
            call.enqueue(new Callback<DietDataModel.Root>() {
                ...
                public void onResponse(Call<DietDataModel.Root> call, Response<DietDataModel.Root> response) {
                    ...
                    Toast.makeText(AddExtraBreakfastTertiaryActivity.this, "Add diet", Toast.LENGTH_SHORT).show();
