...
public class AddExtraLunchTertiaryActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    Root modelList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_extra_lunch_tertiary);
      ...
      //  increaseBtn.setOnClickListener(new View.OnClickListener() {
        ...
        btnsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    boolean networkConectivity =  NetworkConnectivity.isConnected(AddExtraLunchTertiaryActivity.this);
        ...
        timetext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TimePickerDialog mTimePicker=new TimePickerDialog(AddExtraLunchTertiaryActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        datetext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DatePickerDialog dialog = new DatePickerDialog(AddExtraLunchTertiaryActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
...
//
        try {
            ...
            call.enqueue(new Callback<DietDataModel.Root>() {
                ...
                public void onResponse(Call<DietDataModel.Root> call, Response<DietDataModel.Root> response) {
                    ...
                    Toast.makeText(AddExtraLunchTertiaryActivity.this, "Add diet", Toast.LENGTH_SHORT).show();

                    if (response.code() == 200) {
                        String responseString = "Response code :" + response.code();
                        Toast.makeText(AddExtraLunchTertiaryActivity.this, "Add ExtraLunch Diet Successfully", Toast.LENGTH_SHORT).show();
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
        ...
        Toast.makeText(AddExtraLunchTertiaryActivity.this, "Selected Item is: \t" + lunchh, Toast.LENGTH_LONG).show();
        SharedPreference.saveSharedSetting(AddExtraLunchTertiaryActivity.this, "extra_lunch", lunchh);
    }
}