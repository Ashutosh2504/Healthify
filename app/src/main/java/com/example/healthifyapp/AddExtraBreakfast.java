                    ...
                    if (networkConectivity) {
                        ...
                        if (isAllFieldsChecked = CheckAllFields()) {
                            ...
                            timetext.setText("");
                                ...
                                Toast.makeText(AddExtraBreakfast.this, "Food Item can't be found", Toast.LENGTH_SHORT).show();
...
//        DietApi dietApi=retrofit.create(DietApi.class);
     try {
        ...
        DietDataModel dietAnalysisDetailList = new DietDataModel(quantity, item, "500");
        ...
        Gson g1 = new Gson();
        Log.d("Sending data:", g1.toJson(dietDataModel));
            ...
            public void onResponse(Call<ArrayList<FoodDietModel>> call, Response<ArrayList<FoodDietModel>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    for (Map.Entry<String, String> breakfast : foodWithKcal.entrySet()) {
                        Log.d("KCAL", ":" + breakfast.getKey()+"-> "+breakfast.getValue());
                    }
                }
            }
