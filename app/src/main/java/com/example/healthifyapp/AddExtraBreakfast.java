...
public class AddExtraBreakfast extends AppCompatActivity  implements AdapterView.OnItemClickListener {
  ...
  LinearLayout back_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_extra_breakfast);
       ...
       // textViewDiettypeprimary=findViewById(R.id.breakfastprimary);
        ...
        back_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(AddExtraBreakfast.this, PrimaryAnalysisDietACtivity.class);
      ...
      //  decreaseBtn.setOnClickListener(new View.OnClickListener() {
       ...
       /* addbreakfastedittext.addTextChangedListener(new TextWatcher() {
        ...
        btnsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    boolean networkConectivity =  NetworkConnectivity.isConnected(AddExtraBreakfast.this);
                ...
                Toast.makeText(AddExtraBreakfast.this, "Add diet Successfully", Toast.LENGTH_SHORT).show(); // Due to no response from get from api but data is stored.. 200 code is returned and check log for response
            }
                    else {
                NetworkConnectivity.networkConnetivityShowDialog(AddExtraBreakfast.this);
        ...
        timetext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TimePickerDialog mTimePicker = new TimePickerDialog(AddExtraBreakfast.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        datetext1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DatePickerDialog dialog = new DatePickerDialog(AddExtraBreakfast.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                        ...
                        for (int i=0; i<resultList.size();i++){
                            ...
                            try {
                                if (resultList.get(i).getDietAnalysisType().equalsIgnoreCase("Primary Analysis Of Your Diet")) {
                                    if (resultList.get(i).getDietType().equalsIgnoreCase("ADD EXTRA BREAKFAST")) {
     ...
     try {
        ...
        call.enqueue(new Callback<DietDataModel.Root>() {
            ...
            public void onResponse(Call<DietDataModel.Root> call, Response<DietDataModel.Root> response) {
                ...
                Toast.makeText(AddExtraBreakfast.this, "Add diet", Toast.LENGTH_SHORT).show();
                ...
                if (response.code() == 200) {
                    ...
                    Toast.makeText(AddExtraBreakfast.this, "Add ExtraBreakfast Diet Successfully", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(AddExtraBreakfast.this, "Failed", Toast.LENGTH_SHORT).show();
                    String responseString = "Response code :" + response.code();
                    Log.e("TAG", "Response =" + responseString);
 ...
 catch (Exception e)
 {
  ...
  /*  private void getItemDiet(String s) {
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
        ...
        Toast.makeText(AddExtraBreakfast.this, "Selected Item is: \t" + breakFastfood, Toast.LENGTH_LONG).show();
        SharedPreference.saveSharedSetting(AddExtraBreakfast.this, "extra_breakfast", breakFastfood);
    }
}
