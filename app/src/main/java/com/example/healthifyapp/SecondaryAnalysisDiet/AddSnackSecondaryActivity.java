...
import com.example.healthifyapp.AddSnack;
...
public class AddSnackSecondaryActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_snack_secondary);
     ...
     //   increaseBtn.setOnClickListener(new View.OnClickListener() {
        ...
        btnsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    try {
                        boolean networkConectivity =  NetworkConnectivity.isConnected(AddSnackSecondaryActivity.this);
                ...
                {
                    Toast.makeText(AddSnackSecondaryActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
        ...
        try {
            timetext.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    TimePickerDialog mTimePicker = new TimePickerDialog(AddSnackSecondaryActivity.this, new TimePickerDialog.OnTimeSetListener() {
                        @Override
            ...
            datetext1.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    DatePickerDialog dialog = new DatePickerDialog(AddSnackSecondaryActivity.this, new DatePickerDialog.OnDateSetListener() {
                        @Override
        ...
        try {
            ...
            call.enqueue(new Callback<DietDataModel.Root>() {
                ...
                public void onResponse(Call<DietDataModel.Root> call, Response<DietDataModel.Root> response) {
                    ...
                    Toast.makeText(AddSnackSecondaryActivity.this, "Add diet", Toast.LENGTH_SHORT).show();

                    if (response.code() == 200) {
                        String responseString = "Response code :" + response.code();
                        Toast.makeText(AddSnackSecondaryActivity.this, "Add diet Successfully", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(AddSnackSecondaryActivity.this, "Failed", Toast.LENGTH_SHORT).show();
                        String responseString = "Response code :" + response.code();
                        Log.e("TAG", "Response =" + responseString);
