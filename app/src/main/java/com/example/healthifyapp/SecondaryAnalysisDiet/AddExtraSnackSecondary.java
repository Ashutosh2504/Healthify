...
import com.example.healthifyapp.AddExtraSnackActivity;
...
public class  AddExtraSnackSecondary extends AppCompatActivity implements AdapterView.OnItemClickListener {
    Root modelList;
  ...
  EditText textViewquantity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_extra_snack_secondary);
       ...
       /* addbreakfastedittext.addTextChangedListener(new TextWatcher() {
        ...
        btnsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    try {
                        boolean networkConectivity =  NetworkConnectivity.isConnected(AddExtraSnackSecondary.this);
        ...
        try {
            timetext.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    TimePickerDialog mTimePicker = new TimePickerDialog(AddExtraSnackSecondary.this, new TimePickerDialog.OnTimeSetListener() {
                        @Override
            ...
            datetext1.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    DatePickerDialog dialog = new DatePickerDialog(AddExtraSnackSecondary.this, new DatePickerDialog.OnDateSetListener() {
                        @Override
        ...
        try {
            ...
            call.enqueue(new Callback<DietDataModel.Root>() {
                ...
                public void onResponse(Call<DietDataModel.Root> call, Response<DietDataModel.Root> response) {
                    ...
                    Toast.makeText(AddExtraSnackSecondary.this, "Add diet", Toast.LENGTH_SHORT).show();

                    if (response.code() == 200) {
                        String responseString = "Response code :" + response.code();
                        Toast.makeText(AddExtraSnackSecondary.this, "Add diet Successfully", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(AddExtraSnackSecondary.this, "Failed", Toast.LENGTH_SHORT).show();
                        String responseString = "Response code :" + response.code();
                        Log.e("TAG", "Response =" + responseString);
