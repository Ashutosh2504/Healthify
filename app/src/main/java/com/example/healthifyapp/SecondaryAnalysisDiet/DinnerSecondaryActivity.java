...
public class DinnerSecondaryActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
   ...
   EditText textViewquantity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dinner_secondary);
     ...
     //   kcalstext = findViewById(R.id.kcal);
       ...
       // increaseBtn.setOnClickListener(new View.OnClickListener() {
        ...
        //
        //
        //                    Toast.makeText(DinnerSecondaryActivity.this, "cal"+kcalorie, Toast.LENGTH_SHORT).show();
       ...
       /* addbreakfastedittext.addTextChangedListener(new TextWatcher() {
        ...
        btnsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    boolean networkConectivity =  NetworkConnectivity.isConnected(DinnerSecondaryActivity.this);
                    if (networkConectivity) {
                        ...
                        NetworkConnectivity.networkConnetivityShowDialog(DinnerSecondaryActivity.this);
        ...
        timetext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TimePickerDialog mTimePicker = new TimePickerDialog(DinnerSecondaryActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        datetext1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DatePickerDialog dialog = new DatePickerDialog(DinnerSecondaryActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        try {
            ...
            call.enqueue(new Callback<DietDataModel.Root>() {
                ...
                public void onResponse(Call<DietDataModel.Root> call, Response<DietDataModel.Root> response) {
                    ...
                    Toast.makeText(DinnerSecondaryActivity.this, "Add diet", Toast.LENGTH_SHORT).show();

                    if (response.code() == 200) {
                        String responseString = "Response code :" + response.code();
                        Toast.makeText(DinnerSecondaryActivity.this, "Add ExtraBreakfast Diet Successfully", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(DinnerSecondaryActivity.this, "Failed", Toast.LENGTH_SHORT).show();
                        String responseString = "Response code :" + response.code();
                        Log.e("TAG", "Response =" + responseString);
