...
public class LunchSecondaryActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    Root modelList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lunch_secondary);
        ...
        btnsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    try {
                        boolean networkConectivity =  NetworkConnectivity.isConnected(LunchSecondaryActivity.this);
                        if (networkConectivity) {
                            ...
                            NetworkConnectivity.networkConnetivityShowDialog(LunchSecondaryActivity.this);
        ...
        timetext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try{
                    ...
                    TimePickerDialog mTimePicker=new TimePickerDialog(LunchSecondaryActivity.this, new TimePickerDialog.OnTimeSetListener() {
                        @Override
        ...
        datetext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    DatePickerDialog dialog = new DatePickerDialog(LunchSecondaryActivity.this, new DatePickerDialog.OnDateSetListener() {
                        @Override
        ...
        try {
            ...
            call.enqueue(new Callback<DietDataModel.Root>() {
                ...
                public void onResponse(Call<DietDataModel.Root> call, Response<DietDataModel.Root> response) {
                    ...
                    Toast.makeText(LunchSecondaryActivity.this, "Add diet", Toast.LENGTH_SHORT).show();

                    if (response.code() == 200) {
                        String responseString = "Response code :" + response.code();
                        Toast.makeText(LunchSecondaryActivity.this, "Add diet Successfully", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(LunchSecondaryActivity.this, "Failed", Toast.LENGTH_SHORT).show();
                        String responseString = "Response code :" + response.code();
                        Log.e("TAG", "Response =" + responseString);
