...
public class AddextraDinnerActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
  ...
  EditText textViewquantity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addextra_dinner);
     ...
     //   kcalstext = findViewById(R.id.kcal);
      //  increaseBtn = findViewById(R.id.increase);
        ...
        back_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(AddextraDinnerActivity.this, SecondaryAnalysisdietActivity.class);
        ...
        getbrakfast(userAccountId,fromdate,todaydate);
        getAllFoodItems();
      ...
      //  increaseBtn.setOnClickListener(new View.OnClickListener() {
        ...
        //
        //                        Toast.makeText(AddextraDinnerActivity.this, "cal"+kcalorie, Toast.LENGTH_SHORT).show();
        //
        //                        kcalstext.setText(String.valueOf(kcalorie));
        //                        display(tempQuantity);
        //
      ...
      //  LinearLayout linearLayout1 = findViewById(R.id.layout_breakfast);
        btnsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    boolean networkConectivity =  NetworkConnectivity.isConnected(AddextraDinnerActivity.this);
                    if (networkConectivity) {
                        if (isAllFieldsChecked = CheckAllFields()) {
                         ...
                         Toast.makeText(AddextraDinnerActivity.this, "Add Extra Dinner Successfully", Toast.LENGTH_SHORT).show(); // Due to no response from get from api but data is stored.. 200 code is returned and check log for response

                    }
                    else {
                        NetworkConnectivity.networkConnetivityShowDialog(AddextraDinnerActivity.this);
        ...
        timetext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TimePickerDialog mTimePicker = new TimePickerDialog(AddextraDinnerActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        datetext1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DatePickerDialog dialog = new DatePickerDialog(AddextraDinnerActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    private void getbrakfast(int userAccountId,String fromdate,String todaydate) {
...
//        DietApi dietApi=retrofit.create(DietApi.class);
        try {
            ...
            call.enqueue(new Callback<DietDataModel.Root>() {
                ...
                public void onResponse(Call<DietDataModel.Root> call, Response<DietDataModel.Root> response) {
                    ...
                    Toast.makeText(AddextraDinnerActivity.this, "Add diet", Toast.LENGTH_SHORT).show();

                    if (response.code() == 200) {
                        String responseString = "Response code :" + response.code();
                        Toast.makeText(AddextraDinnerActivity.this, "Add  Diet Successfully", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(AddextraDinnerActivity.this, "Failed", Toast.LENGTH_SHORT).show();
                        String responseString = "Response code :" + response.code();
                        Log.e("TAG", "Response =" + responseString);
  ...
  /*  private void getItemDiet(String s) {
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
        ...
        Toast.makeText(AddextraDinnerActivity.this, "Selected Item is: \t" + breakFastfood, Toast.LENGTH_LONG).show();
        SharedPreference.saveSharedSetting(AddextraDinnerActivity.this, "extra_breakfast", breakFastfood);
    }
}