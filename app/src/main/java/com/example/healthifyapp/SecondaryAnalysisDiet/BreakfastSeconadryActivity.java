...
public class BreakfastSeconadryActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    Root modelList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_breakfast_seconadry);
       ...
       // increaseBtn.setOnClickListener(new View.OnClickListener() {
        ...
        btnsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    try {
                        boolean networkConectivity =  NetworkConnectivity.isConnected(BreakfastSeconadryActivity.this);
                        if (networkConectivity) {
                            ...
                            NetworkConnectivity.networkConnetivityShowDialog(BreakfastSeconadryActivity.this);
        ...
        try {
            timetext.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    TimePickerDialog mTimePicker = new TimePickerDialog(BreakfastSeconadryActivity.this, new TimePickerDialog.OnTimeSetListener() {
                        @Override
            ...
            datetext1.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    DatePickerDialog dialog = new DatePickerDialog(BreakfastSeconadryActivity.this, new DatePickerDialog.OnDateSetListener() {
                        @Override
            ...
            call.enqueue(new Callback<DietDataModel.Root>() {
                ...
                public void onResponse(Call<DietDataModel.Root> call, Response<DietDataModel.Root> response) {
                    ...
                    if (response.code() == 200) {
                        ...
                        Toast.makeText(BreakfastSeconadryActivity.this, "Add diet Successfully", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(BreakfastSeconadryActivity.this, "Failed", Toast.LENGTH_SHORT).show();
                        String responseString = "Response code :" + response.code();
                        Log.e("TAG", "Response =" + responseString);
