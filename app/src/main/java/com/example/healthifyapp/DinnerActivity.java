    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  increaseBtn = findViewById(R.id.increase);
        ...
        btnsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    boolean networkConectivity =  NetworkConnectivity.isConnected(DinnerActivity.this);
                    if (networkConectivity) {
                        if (isAllFieldsChecked = CheckAllFields()) {
                            if (!(breakFastfood == null)) {
                                ...
                                Toast.makeText(DinnerActivity.this, "Food Item can't be found", Toast.LENGTH_SHORT).show();
            ...
            call.enqueue(new Callback<DietDataModel.Root>() {
                ...
                public void onResponse(Call<DietDataModel.Root> call, Response<DietDataModel.Root> response) {
                    ...
                    if (response.code() == 200) {
                        ...
                        Toast.makeText(DinnerActivity.this, "Add ExtraBreakfast Diet Successfully", Toast.LENGTH_SHORT).show();
