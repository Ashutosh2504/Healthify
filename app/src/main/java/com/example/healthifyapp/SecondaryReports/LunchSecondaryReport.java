...
public class LunchSecondaryReport extends AppCompatActivity {
    int userAccountId =0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lunch_secondary_report);
        linearLayoutButton = findViewById(R.id.btn_BackBreakFast);
        //  lunchPrimaryReportDataModels = new ArrayList<>();
        recyclerView = (RecyclerView) findViewById(R.id.lunch);
        ...
        fromdate_txt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog dialog = new DatePickerDialog(LunchSecondaryReport.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        sort_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                getLunchPrimaryAnalysisReport(LunchSecondaryReport.this);
