package com.example.healthifyapp.SecondaryReports;
...
import com.example.healthifyapp.report.BreakFastprimaryanalysisReport;
import com.example.healthifyapp.report.DinnerPrimaryAnalysisReport;
...
public class SecondaryReport extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_secondary_report);
        ...
        cardView_snackbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(SecondaryReport.this,  SnackSecondaryReport.class);
...
//change this button
        ...
        breakfast_Button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(SecondaryReport.this, BreakfastSecondaryReport.class);
                startActivity(intent);
        ...
        dinner_Button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(SecondaryReport.this, DinnerSeconadryReport.class);
                startActivity(intent);
            }
        });
        ...
        lunchReport_Button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(SecondaryReport.this, LunchSecondaryReport.class);
                startActivity(intent);
            }
        });
    }
