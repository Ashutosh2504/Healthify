...
public class DinnerSeconadryReport extends AppCompatActivity {
    int userAccountId =0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dinner_seconadry_report);
        ...
        fromdate_txt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog dialog = new DatePickerDialog(DinnerSeconadryReport.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        sort_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                getDinnerPrimaryAnalysisReport(DinnerSeconadryReport.this);
