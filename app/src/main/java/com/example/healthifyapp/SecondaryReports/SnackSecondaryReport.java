...
public class SnackSecondaryReport extends AppCompatActivity {
    int userAccountId =0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_snack_secondary_report);
        ...
        fromdate_txt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog dialog = new DatePickerDialog(SnackSecondaryReport.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        sort_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                getLunchPrimaryAnalysisReport(SnackSecondaryReport.this);
        ...
        linearLayoutButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SnackSecondaryReport.this, SecondaryReport.class);
                ...
                public void onResponse(Call<Root> call, Response<Root> response) {
                    try{
                        if (response.code() ==200)
                        {
                            ...
                            Toast.makeText(SnackSecondaryReport.this, "Add diet Successfully", Toast.LENGTH_SHORT).show();
                            ...
                            for (int i=0; i<resultList.size();i++){
                                ...
                                try {
                                    if (resultList.get(i).getDietAnalysisType().equalsIgnoreCase("Secondary Analysis Of Your Diet")) {
                                        ...
                                        } else if (resultList.get(i).getDietType().equalsIgnoreCase("ADD EXTRA SNACK")) {
