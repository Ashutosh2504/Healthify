...
public class BreakfastSecondaryReport extends AppCompatActivity {
 ...
 Button sort_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_break_fast_seconadry_report);
        ...
        fromdate_txt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog dialog = new DatePickerDialog(BreakfastSecondaryReport.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
       ...
       dialog(false);
        ...
        sort_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                getLunchPrimaryAnalysisReport(BreakfastSecondaryReport.this);
        ...
        linearLayoutButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(BreakfastSecondaryReport.this, SecondaryReport.class);
            ...
            call.enqueue(new Callback<Root>() {
                ...
                public void onResponse(Call<Root> call, Response<Root> response) {
                    ...
                    if (response.code() ==200)
                    {
                        ...
                        Toast.makeText(BreakfastSecondaryReport.this, "Add diet Successfully", Toast.LENGTH_SHORT).show();
