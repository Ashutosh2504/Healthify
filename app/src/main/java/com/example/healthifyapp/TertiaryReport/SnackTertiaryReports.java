...
public class SnackTertiaryReports extends AppCompatActivity {
    int userAccountId =0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_snack_tertiary_reports);
        ...
        fromdate_txt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog dialog = new DatePickerDialog(SnackTertiaryReports.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        sort_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                getLunchPrimaryAnalysisReport(SnackTertiaryReports.this);
                            ...
                            for (int i=0; i<resultList.size();i++){
                                ...
                                try {
                                    if (resultList.get(i).getDietAnalysisType().equalsIgnoreCase("Tertiary Analysis Of Your Diet")) {
                                        if (resultList.get(i).getDietType().equalsIgnoreCase("SNACK")) {
