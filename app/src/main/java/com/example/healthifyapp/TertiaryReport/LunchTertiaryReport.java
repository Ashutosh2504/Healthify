...
public class LunchTertiaryReport extends AppCompatActivity {
    int userAccountId =0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lunch_tertiary_report);
        ...
        fromdate_txt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog dialog = new DatePickerDialog(LunchTertiaryReport.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        sort_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                getLunchPrimaryAnalysisReport(LunchTertiaryReport.this);
