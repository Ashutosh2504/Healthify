...
EditText textViewquantity;
    ...
    String[] unit={"Grams","Plates","Pcs","Ml"};
    Spinner unitspinner;
        ...
        btnsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    try {
                        boolean networkConectivity =  NetworkConnectivity.isConnected(LunchActivity.this);
                        if (networkConectivity) {
                            ...
                            if (isAllFieldsChecked = CheckAllFields()) {
                                if (!(lunchh == null)) {
                                    ...
                                    Toast.makeText(LunchActivity.this, "Food Item can't be found", Toast.LENGTH_SHORT).show();
                            ...
                            NetworkConnectivity.networkConnetivityShowDialog(LunchActivity.this);
...
// mCalendar will be set to current/today's date
                    ...
                    dialog.getDatePicker().setMinDate(mCalendar.getTimeInMillis());                    dialog.getDatePicker().setMaxDate(System.currentTimeMillis());
                dialog.show();
                //dialog.show();
                }
                catch (Exception e)
