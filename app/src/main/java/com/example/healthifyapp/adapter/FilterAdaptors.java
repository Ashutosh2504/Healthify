...
public class FilterAdaptors extends RecyclerView.Adapter<FilterAdaptors.MyviewHolder>  {
    ...
    public FilterAdaptors(Context context, List<Root.Result.DietAnalysisDetails> dietAnalysisReport) {
        this.context = context;
        this.dietAnalysisReport = dietAnalysisReport;

    }
    public void setDietAnalysis(List<Root.Result.DietAnalysisDetails> dietAnalysisReport) {
        this.dietAnalysisReport = dietAnalysisReport;
        //  dietAnalysisReport.clear();
        //  dietAnalysisReport.addAll(dietAnalysisReport);
        // dietAnalysisReport.clear();
        //  dietAnalysisReport.addAll(dietAnalysisReport);
notifyDataSetChanged();
    ...
    @NonNull
    @Override
    public FilterAdaptors.MyviewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.activity_break_fast_report, parent, false);
        return new FilterAdaptors.MyviewHolder(view);
