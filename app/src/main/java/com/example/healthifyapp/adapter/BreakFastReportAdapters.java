...
public class BreakFastReportAdapters extends RecyclerView.Adapter<BreakFastReportAdapters.MyviewHolder>  {
    ...
    public BreakFastReportAdapters(Context context, List<Root.Result.DietAnalysisDetails> dietAnalysisReport) {
        this.context = context;
        this.dietAnalysisReport = dietAnalysisReport;
        dietAnalysisReport= new ArrayList<>();
    }
    ...
    @NonNull
    @Override
    public BreakFastReportAdapters.MyviewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
          View view = LayoutInflater.from(context).inflate(R.layout.activity_break_fast_report, parent, false);
          return new BreakFastReportAdapters.MyviewHolder(view);
