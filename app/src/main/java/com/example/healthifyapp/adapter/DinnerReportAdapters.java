...
public class DinnerReportAdapters extends RecyclerView.Adapter<DinnerReportAdapters.MyviewHolder> {
    ...
    public DinnerReportAdapters(Context context, List<Root.Result.DietAnalysisDetails> dietAnalysisReport) {
    ...
    @NonNull
    @Override
    public DinnerReportAdapters.MyviewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.activity_dinner_report, parent, false);
        return new DinnerReportAdapters.MyviewHolder(view);
