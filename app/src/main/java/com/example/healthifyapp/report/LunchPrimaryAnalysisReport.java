                            ...
                            for (int i = 0; i < resultList.size(); i++) {
                                ...
                                if (resultList.get(i).getDietAnalysisType().equalsIgnoreCase("Primary Analysis Of Your Diet")) {
                                    ...
                                    if (resultList.get(i).getDietType().equalsIgnoreCase("LUNCH")
                                            ||resultList.get(i).getDietType().equalsIgnoreCase("ADD EXTRA LUNCH")) {
                ...
                public void onResponse(Call<Root> call, Response<Root> response) {
                    ...
                    if (response.code() ==200)
                    {
                        ...
                        for (int i=0; i<resultList.size();i++){
                            ...
                            try {
                                if (resultList.get(i).getDietAnalysisType().equalsIgnoreCase("Primary Analysis Of Your Diet")) {
                                    if (resultList.get(i).getDietType().equalsIgnoreCase("LUNCH") || resultList.get(i).getDietType().equalsIgnoreCase("ADD EXTRA LUNCH")) {
