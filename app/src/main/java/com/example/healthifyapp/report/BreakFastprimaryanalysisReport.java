       ...
       // layout2=findViewById(R.id.layoutrecycleview2);
        ...
        recyclerView1 = (RecyclerView) findViewById(R.id.breakfastrecylesview1);
                       recyclerView1.setHasFixedSize(true);
                        dietAnalysisDetails = new ArrayList<Root.Result.DietAnalysisDetails>();
                        dietAnalysisType = new ArrayList<Root.Result.DietAnalysisDetails>(); progressBar=findViewById(R.id.pb);
        ...
        sort_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //if (isAllFieldsChecked = CheckAllFields()) {
                    ...
                    /*todaydate1 = todaydate_txt.getText().toString();
                    fromdate1 = fromdate_txt.getText().toString();*/
                   // getLunchPrimaryAnalysisReport(BreakFastprimaryanalysisReport.this);
