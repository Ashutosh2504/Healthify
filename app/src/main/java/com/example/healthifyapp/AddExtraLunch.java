...
public class AddExtraLunch extends AppCompatActivity implements AdapterView.OnItemClickListener {
    Root modelList;
  ...
  EditText textViewquantity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_extra_lunch);
     ...
     //   kcalstext = findViewById(R.id.kcal);
       ...
       // textViewprimaryanalysis=findViewById(R.id.lunchprimary);
        ...
        lunch = findViewById(R.id.lunchh);
        ...
        btnsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    boolean networkConectivity =  NetworkConnectivity.isConnected(AddExtraLunch.this);
                    if (networkConectivity) {
                        if (isAllFieldsChecked = CheckAllFields()) {
                            if (!(lunchh == null)) {
                                ...
                                Toast.makeText(AddExtraLunch.this, "Food Item can't be found", Toast.LENGTH_SHORT).show();
        ...
        timetext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TimePickerDialog mTimePicker=new TimePickerDialog(AddExtraLunch.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        datetext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DatePickerDialog dialog = new DatePickerDialog(AddExtraLunch.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
...
//
        ...
        call.enqueue(new Callback<DietDataModel.Root>() {
            ...
            public void onResponse(Call<DietDataModel.Root> call, Response<DietDataModel.Root> response) {
                ...
                Toast.makeText(AddExtraLunch.this, "Add diet", Toast.LENGTH_SHORT).show();

                if (response.code() == 200) {
                    String responseString = "Response code :" + response.code();
                    Toast.makeText(AddExtraLunch.this, "Add ExtraLunch Diet Successfully", Toast.LENGTH_SHORT).show();
